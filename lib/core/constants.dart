...
class AppConstants {
  ...
  static const String routeDashboardQuizzes    = '/dashboard/quizzes';
  static const String routeDashboardAssignments = '/dashboard/assignments';
  static const String routeDashboardLearning    = '/dashboard/learning';
